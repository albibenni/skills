...
*   **Distrattori Plausibili ed Equilibrati**: Evita pattern facilmente riconoscibili (ad esempio, evitare che la risposta esatta sia sempre la più lunga o dettagliata). Mantieni le opzioni di lunghezza, complessità sintattica e stile scientifico simili tra loro. Varia in modo casuale la lettera della risposta corretta (A, B, C o D).
